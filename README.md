...
> -db-, «§», «Ag~, «Ð²Ä», «MAD», [Aķ], [CV], [GTV], [IG], [IS], [K2], [McK], [Nbk], [VR], ]ZTA[. VSA, {ATP}, {BK}, {CK},
> {HWS}, {LoH}, {NR}, {ØZ}, {SSC}, {V3}, {X}, {XF} = SL =, {XG}, = EP =, = NcS =, = XA=, £V», ÄÄÄ, AOD, AR, BR, BZ, C#w,
> CB, CES, CGD, CHr, CK, ÇM, CODE, CSI, CST, DFS, DR, Ðu¥, EK, ev, FCM, Fem1, Fez`, FIG, FooK, GDS, GoD, GRO, HH, HSF,
> HTK3, IR, KB, KMT, KoD, KoF, LaG, LF, LIB, LNZ, LP, LTD2, M5, MR, MVL, ňc, ÑE», ñuß, OSR, OWV, P§ycho, PÕQ, PRO, RC,
> RSF, SAR, SB, SDR, ßE, TBR, TCS, TFT, TM, ToR, X¬, xOSHx, xT
