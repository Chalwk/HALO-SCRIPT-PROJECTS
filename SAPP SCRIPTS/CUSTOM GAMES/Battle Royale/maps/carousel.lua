    ...
    crates = {
        ...
        spoils = {
            ...
            { -- GRENADES {frags, plasmas}
                enabled = true,
                count = { 3, 3 }, -- keeps corridor fights controlled
            },
            { -- CAMOFLAGE
                enabled = true,
                durations = { 25, 40, 55, 70, 85 }, -- shorter max to keep fights fast-paced
            },
            ...
            { -- HEALTH BOOST (picks a random multiplier)
                enabled = true,
                levels = { 1.25, 1.35, 1.45 }, -- balanced for multi-level duels
            }
        }
    }
}
